function [T_all, mean_dist] = ukf_isotropic_registration_ex1(moving, fixed, varargin)
...
for iter=1:max_iter
    ...
    if(normal_specified)
        ...
        [idx, dist] = knnsearch(Y_breve_withnormals', U_k_withnormals', 'Distance', 'euclidean');
        Y_k         = Y_breve(:, idx);
        mean_dist   = mean(dist);
